 ...
 <div class="sub-banner">
	<div class="container">
		<div class="text-detail">
			<h2><?php if ( isset( $architecture_theme_options['projects-archive-page-title'] ) ){ echo esc_html( $architecture_theme_options['projects-archive-page-title'] ); } ?></h2>
			<p><?php if ( isset( $architecture_theme_options['projects-archive-page-sub-title'] ) ){ echo esc_html( $architecture_theme_options['projects-archive-page-sub-title'] ); } ?></p>
